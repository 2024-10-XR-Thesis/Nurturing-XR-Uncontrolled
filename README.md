...
3. Empezar una transmisión en su computador: [instrucciones](https://www.meta.com/help/quest/articles/in-vr-experiences/oculus-features/cast-with-quest/). Asegúrese que la transmisión se encuentra en el primer plano de la pantalla, y que está en el monitor principal si tiene más de uno. También se recomienda ampliar la pantalla para que la transmisión sea lo único visible.
